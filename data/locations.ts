...
export const locations: LocationPoint = [
  ...
  },
  {
    ...
    images: ["/photos/kladbische-1.jpg", "/photos/kladbische-2.jpg"],
    confidence: true,
  },
  {
    id: "bones",
  ...
  },
  {
    ...
    images: ["/photos/mtf-2-2.jpg", "/photos/mtf-2-1.jpg"],
    confidence: true,
  },
  {
    id: "stf",
  ...
  },
  {
    ...
    coords: [52.2644, 107.779215],
    type: "current",
    description:
      "Здание местного клуба, построенное в 1965 году. В нём расположены зрительный зал, библиотека, комната боевой славы, кружки и студии. В 2011 году здесь открылся культурно-информационный центр. С 2013 года директор — Голубева С. А. В 2025 году клуб вошёл в федеральную программу капремонта — выделили больше 9 миллионов рублей. Жители ждут, что здесь станет тепло, уютно и красиво. Сейчас в клубе плетут маскировочные сети, занимаются дети и взрослые. Это единственное место в селе, где ещё можно собраться всем вместе.",
    images: [
      "/photos/kic-1.jpg",
      "/photos/kic-2.jpg",
      "/photos/kic-3.jpg",
  ...
  {
    id: "administration",
    name: "Администрация (бывшая часовня Николая Чудотворца)",
    coords: [52.265657, 107.775429],
    type: "history",
    description:
      "На этом месте раньше стояла часовня во имя святого Николая Чудотворца. В 1817 году она числилась в архивных документах. Позже часовня была утрачена, а на её месте выросло здание сельской администрации. Зарегистрирована 24 декабря 2005 года. Глава — Погорельский Владимир Викторович.",
    images: ["/photos/admin-1.jpg", "/photos/admin-2.jpg"],
    confidence: true,
  },
  {
    id: "teplitci",
  ...
  },
  {
    ...
    images: ["/photos/burn-club-1.jpg"],
    confidence: true,
  },
  {
    id: "berezka",
    name: "Магазин «Берёзка» (бывший химсклад)",
    coords: [52.265263, 107.778942],
    type: "history",
    description:
      "Сейчас здесь продуктовый магазин «Берёзка» (рядом с детским садом), но раньше в этом здании был химсклад. Хранили удобрения, ядохимикаты, семена. Запах был такой, что дети обходили стороной. Потом склад закрыли, здание стояло пустым. Позже в него заехал магазин — я помню, как в детстве мама брала меня с собой, я сидел в коляске и ждал её на улице. Магазин пережил несколько закрытий, но в 2026 году открылся снова — теперь уже как «Берёзка».",
    images: [
  ...
  },
  {
    ...
    type: "history",
    description:
      "В этом здании сейчас магазин «Весна». Когда-то давно магазин занимал часть здания КИЦ, а потом его перенесли сюда — увеличение, масштабирование. Просто деревенское расширение торговли. Но главное — до «Весны» здесь было что-то ещё. На втором этаже я помню кровати. Что это было? Никто не знает. Может, общежитие, может, жильё для работников, может, даже больница. Точной информации нет. «Весна» заехала, и память о том, что было до неё, стёрлась. Остались только кровати в моей голове.",
    images: [
      "/photos/vesna-1.jpg",
      "/photos/vesna-2.jpg",
      "/photos/vesna-3.jpg",
