...
export const locations: LocationPoint[] = [
 {
    ...
    type: "history",
    description:
      "В XIX — начале XX века здесь стояла одна из трёх часовен. В 1930-х её разрушили. В 2013 году местный житель Геннадий Севергин поставил на этом месте поклонный крест — чтобы место не забыли. Зимой дети частенько скатываются с нее на санях. Сейчас это тихая гора над Итанцей, где раньше молились, а теперь ветер.",
    images: [
  ...
  },
 {
    ...
    type: "history",
    description:
      "Место слияния Итанцы и Ангыра издревле привлекало для строительства плотин. До ГЭС здесь стояла мельница. Строительство ГЭС началось до 1940 года. 15 сентября 1943 года принято постановление №129 об окончании строительства. Финансировали колхозы: «Путь социализма», им. Чкалова и другие. ГЭС строили по проекту ссыльных инженеров Кайдаша и Полторацкого. Окончанием работ руководил механик Бартеньев Михаил Андреевич. ГЭС была маломощной — не более 50 кВт. После пуска Иркутской ГЭС в 1960 году станцию демонтировали. В селе также было 3 водяные мельницы.",
    images: [
  ...
  },
 {
    ...
    type: "history",
    description:
      "Первая школа в Зырянске открылась в 1905 году — это было начальное училище в здании конца XIX века (ныне администрация). Один из первых учителей — Балданов В.Л., он ушёл на фронт в 1941 году и не вернулся. В 1960-х построили новое здание. В 1967 году начальная школа стала неполной средней, а в 1975 — полной средней школой. Сейчас школа работает, но учеников стало меньше. Деревня стареет.",
    images: [
  ...
  },
{
    ...
    type: "history",
    description:
      "Утаты — это не просто поле за рекой. В XIX — начале XX века здесь была целая деревня. Первыми поселенцами были ссыльные, построившие 17 дворов. Жители работали на свиноферме, куроферме, скотоферме. Кормилицей деревни была мельница, построенная ссыльными инженерами Павлом Кузнецовым и Бляблиным в 1924 году. Здесь были дома, три часовни, зернохранилища. Деревня исчезла в XX веке — в 1930-е или 1950-е годы. Сейчас от Утатов остались только поле, крапива, фундаменты и ямы.",
    images: [],
    confidence: true,
},
{
