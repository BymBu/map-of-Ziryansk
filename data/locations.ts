...
export const locations: LocationPoint = [
  ...
  },
  {
    ...
    type: "history",
    description:
      "ГЭС строили в два этапа. Первый — в 1940 году силами трёх колхозов. Второй — после войны: в 1950 году завершили вторую очередь, и свет пришёл в Ангыр, Батурино и Нестерово. Это было сложное гидротехническое сооружение — для наполнения водохранилища даже спрямили устье реки Ангыр. Директором станции был Георгий Михайлович Юртвенсон. Турбина работала недолго — в 1956 году её заменили на дизельную, а в начале 1960-х село подключили к Братской ГЭС. Соответственно, Зырянскую ГЭС демонтировали.",
    images: [
      "/photos/ges-1.jpg",
      "/photos/ges-2.jpg",
      "/photos/ges-3.jpg",
  ...
  },
  {
    ...
    type: "history",
    description:
      "Молочно-товарная ферма совхоза «Зырянский». Когда-то здесь держали коров, доили, сдавали молоко государству. На пике развития в совхозе было 508 коров и 1619 голов молодняка. Ферма давала работу половине села. Сейчас от неё остались только руины, бетонные плиты и ржавые трубы.",
