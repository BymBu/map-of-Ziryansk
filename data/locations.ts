...
export const locations: LocationPoint = [
  ...
  },
  {
    ...
    type: "current",
    description:
      "Культурно-информационный центр, который работает с 2011 года. Проводят концерты, спектакли, детские и молодёжные мероприятия. Есть бильярд, теннис, тренажёры. Работают патриотические кружки — например, «Память», где детям рассказывают про войну и героев-земляков. Директор — Голубева С. А., с 2013 года. В центре 11 коллективов, участвуют в районных и даже международных мероприятиях. Одно из немногих мест в селе, где ещё есть жизнь.",
    images: [],
    confidence: true,
  },
  {
